...
int main(){
	...
	if(curtime->tm_sec%10==1){
		div1=div2*9;
	}
	else if(curtime->tm_sec%10==2){
		div1=div2*(num%9);
	}
	else if(curtime->tm_sec%10==3){
		div1=(num*13)%(num+20)+div2;
	}
	else if(curtime->tm_sec%10==4){
		div1=div1*17;
	}
	else if(curtime->tm_sec%10==5){
		div1=div1+(div1*5);
	}
	else if(curtime->tm_sec%10==6){
		div1=div1+91;
	}
	else if(curtime->tm_sec%10==7){
		div1=(div2-19)+(num*12);
	}
	else if(curtime->tm_sec%10==8){
		div1=(div2+div1)+(div1+num);
	}
	else if(curtime->tm_sec%10==9){
		div1=(num+num)+23;
	}
